 ...
 */
export interface LocationHistoryDisplay extends Omit<LocationHistory, 'arrivalDate' | 'departureDate' | 'createdAt'> {
  arrivalDate: Date
  departureDate?: Date
  createdAt: Date
 ...
 */
export const STABLE_PERMISSIONS: Record<StableAction, { owner: boolean; manager: boolean; member: boolean }> = {
 ...
 */
export const HORSE_PERMISSIONS: Record<HorseAction, { owner: boolean; manager: boolean; member: boolean }> = {
