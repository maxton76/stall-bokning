...
export type EntryStatus = "pending" | "in-progress" | "completed" | "cancelled";

// Alias for backward compatibility
export type ActivityStatus = EntryStatus;

// Date tab for filtering activities by date range
export type DateTab =
  | "today"
  | "tomorrow"
  | "dayAfter"
...
export type CreateActivityTypeData = Omit<
  ActivityTypeConfig,
  "id" | "stableId" | "createdAt" | "updatedAt" | "createdBy" | "lastModifiedBy"
>;
export type UpdateActivityTypeData = Partial<
  Omit<
    ActivityTypeConfig,
    "id" | "stableId" | "createdAt" | "createdBy" | "isStandard"
  >
>;
...
export type CreateActivityData = Omit<
  Activity,
  | "id"
  | "type"
  | "stableId"
...
// Update data type
export type UpdateActivityEntryData = Partial<
  Omit<ActivityEntry, "id" | "type" | "stableId" | "createdAt" | "createdBy">
>;
