        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="groupBy" className="text-sm font-medium">
              {t("activities:filters.groupBy.label")}
            </Label>
            <Select
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="none">
                  {t("activities:filters.groupBy.none")}
                </SelectItem>
                <SelectItem value="horse">
                  {t("activities:filters.groupBy.horse")}
                </SelectItem>
                <SelectItem value="staff">
                  {t("activities:filters.groupBy.staff")}
                </SelectItem>
                <SelectItem value="type">
                  {t("activities:filters.groupBy.type")}
                </SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="showFinished" className="text-sm font-medium">
              {t("activities:filters.showFinished")}
            </Label>
            <Switch
              id="showFinished"
          ...
          <div className="space-y-2">
            <Label className="text-sm font-medium">
              {t("activities:filters.entryTypes")}
            </Label>
            <div className="space-y-2">
