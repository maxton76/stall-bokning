...
const profileCache = new Map<string, { data: FirestoreUser; fetchedAt: number }>()
...
export async function fetchUserProfile(
  ...
  try {
    ...
    console.warn(`Firestore profile not found for uid: ${uid}`)
    return null
  } catch (error) {
 ...
 */
export function createAppUser(firebaseUser: FirebaseUser, firestoreUser: FirestoreUser | null): AppUser {
