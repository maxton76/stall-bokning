...
export const INVITATION_SCHEMA: ValidationSchema<
  Omit<import("@/services/inviteService").Invitation, "id">
> = {
...
export const STABLE_MEMBER_SCHEMA: ValidationSchema<
  Omit<import("@/types/roles").StableMember, "id">
> = {
  stableId: { required: true, type: "string" },
