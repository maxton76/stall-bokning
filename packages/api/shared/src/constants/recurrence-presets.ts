...
export interface RecurrencePreset {
  ...
  defaultTime?: string; // Default time of day "HH:MM"
  category: RecurringActivityCategory;
  defaultDuration: number; // Default duration in minutes
  defaultWeight: number; // Default task weight (1-4)
 ...
 */
export const DAILY_CARE_PRESETS: RecurrencePreset[] = [
  {
    id: "morning-feed",
 ...
 */
export const WEEKLY_CARE_PRESETS: RecurrencePreset[] = [
  {
    id: "weekdays-only",
 ...
 */
export const HEALTH_CARE_PRESETS: RecurrencePreset[] = [
  {
    id: "farrier-shod",
 ...
 */
export const ALL_RECURRENCE_PRESETS: RecurrencePreset[] = [
  ...DAILY_CARE_PRESETS,
  ...WEEKLY_CARE_PRESETS,
  ...HEALTH_CARE_PRESETS,
];
 ...
 * Get preset by ID
 */
export function getPresetById(id: string): RecurrencePreset | undefined {
