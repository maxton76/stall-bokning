...
export const onRoutineScheduleCreated = onDocumentCreated(
  ...
  async (event) => {
    ...
    try {
      ...
      // Check if instances were already generated by the API route
      ...
      if (!existingInstances.empty) {
        logger.info(
          { executionId, scheduleId },
          "Instances already generated by API route - skipping trigger generation",
        );
        return;
      }
      ...
      if (!scheduleData.endDate) {
        logger.error(
          { executionId, scheduleId },
          "Schedule missing endDate - cannot generate instances",
        );
        return;
      }
