...
#
# This file instantiates all Terraform modules for the production environment.
...
module "cloud_functions" {
  ...
  # Keep all schedulers paused until manually reviewed and enabled
  pause_all_schedulers = true
